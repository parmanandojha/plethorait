  ...
  return (
    ...
    >
      <div className="flex flex-col items-start px-4 sm:px-6 pt-[12vh] sm:pt-[16vh] h-full justify-center">
        <div className="text-[clamp(0.9375rem,2.5vw,1.5rem)] w-full md:w-[35%]">
          We partner with founders and founder-led brands to build, launch &
          scale their digital presence through storytelling
        </div>

        <div className="flex flex-col items-start justify-center text-[clamp(2rem,8vw,7rem)] sm:text-[clamp(3rem,8vw,7rem)] uppercase font-bold py-4 sm:py-5">
          <h1>Storytelling, Design,</h1>
          <h1>Content Production &amp;</h1>
          <h1>Technology.</h1>
        </div>

        <div className="w-full md:w-1/2 flex flex-col md:flex-row items-start md:items-end justify-between gap-4 sm:gap-6">
          <div className="text-[clamp(0.875rem,1.5vw,1rem)] w-full md:w-[38%]">
